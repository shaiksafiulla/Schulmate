...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "schulmate"; //Local Storage Names for PWA
    ...
    //var pwaScope = "/schoolcoremob/";  // Set the scope to /schoolcoremob/
    //var pwaLocation = "/schoolcoremob/_service-worker.js";  // Service worker is in /schoolcoremob/
    ...
    function init_template(){
        ...
        //show login view
       // menu('menu-signin', 'show', 250);
        //menu('menu-graph', 'show', 250);
        function showMenuGraph() {
            //var el = document.getElementById('menu-graph');
            //var modalwindow = new bootstrap.Modal(el);
            //modalwindow.show();

            //var myModalEl = document.getElementById('menu-graph')
        ...
        function setupFooterNavigation() {
            ...
            navLinks.forEach(link => {
                ...
                link.addEventListener('click', function (event) {
                   ...
                   //var rooturl = window.location.origin + window.location.pathname.substr(0, window.location.pathname.lastIndexOf('/'));
